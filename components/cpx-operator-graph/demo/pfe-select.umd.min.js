!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? module.exports = t(require("../../pfelement/dist/pfelement.umd.min"))
    : "function" == typeof define && define.amd
    ? define(["../../pfelement/dist/pfelement.umd.min"], t)
    : (e = e || self).PfeSelect = t(e.PFElement);
}(this, function (e) {
  "use strict";
  ...
  function n(e, t, r) {
    ...
    if (null !== (e = Object.getPrototypeOf(e))) return n(e, t, r);
  }
  var i = function (e, t) {
      if (!e) {
    ...
    r = (function (e, t) {
      ...
      r(a, [{
        ...
        value: function (e, t) {
          t = t ? "true" : "false";
          this.querySelector("select").setAttribute("aria-invalid", t);
        },
      }, {
        key: "html",
        get: function () {
        ...
        set: function (e) {
          this._pfeOptions = 1 < e.filter(function (e) {
              return e.selected;
            }).length
      ...
      r(a, [{
        ...
        value: function () {
          ...
          n(
            ...
            customElements.whenDefined(a.tag).then(function () {
              e.pfeOptions
                ? (e._modifyDOM(), e._init())
                : e.hasLightDOM()
                ? e._init()
                : e.warn(
        ...
        key: "_modifyDOM",
        value: function () {
          var e, t = document.createElement("select");
          this._pfeOptions.map(function (e) {
            e = Object.assign(document.createElement("option"), e);
            t.add(e, null);
          }),
            this.hasLightDOM()
              ? (e = this.querySelector("select")).parentNode.replaceChild(t, e)
              : this.appendChild(t);
        },
      }]),
      a);
  function a() {
    t(this, a);
    var e = i(this, (a.__proto__ || Object.getPrototypeOf(a)).call(this, a));
    return e._pfeOptions = null,
      e._init = e._init.bind(e),
      e._inputChanged = e._inputChanged.bind(e),
      e.observer = new MutationObserver(e._init),
      e;
  }
  return e.create(r), r;
});
