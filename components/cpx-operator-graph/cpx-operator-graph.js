...
var X = 10,
  ...
  l = (e, r = !1) => {
    ...
    if (N.test(e) && (e = parseInt(e, X), !Number.isSafeInteger(e))) {
      throw new RangeError(`${e} exceeds ${Number.MAX_SAFE_INTEGER}.`);
    }
    return e;
  },
  _ = (e, r, s = !1) => {
    ...
    if (e === r) t = 0;
      ...
      if ($ > a) t = 1;
        ...
        let b = c.split(".").map((o) => l(o, !0)),
          ...
          v = Math.max(b.length, T.length),
          x = 0;
        for (; x < v;) {
          let o = b[x], n = T[x];
          if (
            o && !n || i(o) && Number.isInteger(n)
              ? t = 1
              : !o && n || Number.isInteger(o) && i(n)
              ? t = -1
              : o !== n && i(o) && i(n)
              ? t = o.localeCompare(n)
              : Number.isInteger(o) && Number.isInteger(n) &&
                (o > n ? t = 1 : o < n && (t = -1)), Number.isInteger(t)
          ) {
            break;
          }
          x++;
  ...
  activeListener(evt) {
    ...
    if (this.edges && detail) {
      if (detail.version && detail.version !== this.version) {
        ...
        if (
          detail.skip_min && _(this.version, detail.skip_min) >= 0 &&
          _(this.version, detail.skip_max) < 0
        ) {
...
class OperatorIndex {
  ...
  getAllVersions() {
    ...
    const orderedVersions = [
      ...versions.keys(),
    ].sort((a, b) => _(b, a)).reduce(
      (a, c) => a.set(c, versions.get(c)),
      new Map(),
    );
