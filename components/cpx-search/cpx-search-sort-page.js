export class CPXSearchSortPage extends HTMLElement {
    constructor() {
        super();
    ...
    static get tag() { return 'cpx-search-sort-page'; }
    get sort() {
        return this._sort;
    }
    set sort(val) {
...
window.customElements.define(CPXSearchSortPage.tag, CPXSearchSortPage);
