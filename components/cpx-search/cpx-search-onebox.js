export class CPXSearchOneBox extends HTMLElement {
    constructor() {
        super();
    ...
    static get tag() { return 'cpx-search-onebox'; }
    get term() {
...
window.customElements.define(CPXSearchOneBox.tag, CPXSearchOneBox);
