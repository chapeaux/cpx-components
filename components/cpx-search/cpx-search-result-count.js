export class CPXSearchResultCount extends HTMLElement {
    constructor() {
        super();
    ...
    static get tag() { return 'cpx-search-result-count'; }
    get count() {
        return this._count;
    }
    set count(val) {
...
window.customElements.define(CPXSearchResultCount.tag, CPXSearchResultCount);
