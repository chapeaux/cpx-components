import { CPXSearchFilterGroup } from './cpx-search-filter-group.js';
import { CPXSearchFilterItem } from './cpx-search-filter-item.js';
export class CPXSearchFilters extends HTMLElement {
    constructor() {
        super();
...
<div class="control" id="control">
    ...
    addGroups() {
        ...
        for (let i = 0; i < len; i++) {
            let group = new CPXSearchFilterGroup(), groupInfo = groups[i], gLen = groupInfo.items.length;
            for (let j = 0; j < gLen; j++) {
                let item = new CPXSearchFilterItem();
...
window.customElements.define(CPXSearchFilters.tag, CPXSearchFilters);
