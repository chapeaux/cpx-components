export class CPXOneBox extends HTMLElement {
    constructor() {
        super();
        this.template = document.createElement('template');
        this._term = '';
        this._url = '/data/onebox.json';
        this._mock = false;
    ...
    static get tag() { return 'cpx-onebox'; }
    get term() {
...
window.customElements.define(CPXOneBox.tag, CPXOneBox);
