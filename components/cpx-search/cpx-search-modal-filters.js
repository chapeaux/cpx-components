export class CPXSearchModalFilters extends HTMLElement {
    constructor() {
        super();
    ...
    static get tag() { return 'cpx-search-modal-filters'; }
    get html() {
        return `
        <style>
            :host {
...
window.customElements.define(CPXSearchModalFilters.tag, CPXSearchModalFilters);
