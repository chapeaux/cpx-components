import { CPXFilterGroup } from './cpx-filter-group.js';
import { CPXFilterItem } from './cpx-filter-item.js';
export class CPXFilters extends HTMLElement {
    constructor() {
        super();
    ...
    get html() {
        ...
        <style>
            ...
            @media only screen and (max-width: 768px) {
                ...
                cpx-sort-page { display: inline-block; margin: 0;}
...
<div class="split right"><cpx-sort-page></cpx-sort-page></div>
<div class="control" id="control">
    ...
    static get tag() { return 'cpx-filters'; }
    get type() {
        return this._type;
    }
    set type(val) {
    ...
    addGroups() {
        ...
        for (let i = 0; i < len; i++) {
            let group = new CPXFilterGroup(), groupInfo = groups[i], gLen = groupInfo.items.length;
            for (let j = 0; j < gLen; j++) {
                let item = new CPXFilterItem();
...
window.customElements.define(CPXFilters.tag, CPXFilters);
