...
export class CPXFilterActiveItem extends HTMLElement {
    get html() {
        return `${this.active ? `
        <style>
            :host {
    ...
    static get tag() { return 'cpx-filter-active-item'; }
...
window.customElements.define(CPXFilterActiveItem.tag, CPXFilterActiveItem);